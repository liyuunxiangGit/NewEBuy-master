...
@interface SNCycleScrollView : UIView <UIScrollViewDelegate>
{
    ...
    __weak id<SNCycleScrollViewDataSource>  _dataSource;        //weak
    __weak id<SNCycleScrollViewDelegate>    _delegate;          //weak 注意不能将delegate设为self
...
@property (nonatomic, weak)   id <SNCycleScrollViewDataSource> dataSource;
@property (nonatomic, weak)   id <SNCycleScrollViewDelegate>   delegate;
