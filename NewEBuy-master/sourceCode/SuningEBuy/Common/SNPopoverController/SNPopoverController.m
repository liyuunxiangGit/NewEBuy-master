...
- (void)dealloc
{
    TT_RELEASE_SAFELY(_blackLayer);
    TT_RELEASE_SAFELY(_backGroundImageView);
    TT_RELEASE_SAFELY(_maskControl);
    TT_RELEASE_SAFELY(contentViewController_);
    TT_RELEASE_SAFELY(navController_);
...
- (void)commonSetUp
{
    ...
    CGRect frame = CGRectMake(0, 20+44, appFrame.size.width, appFrame.size.height-64);
