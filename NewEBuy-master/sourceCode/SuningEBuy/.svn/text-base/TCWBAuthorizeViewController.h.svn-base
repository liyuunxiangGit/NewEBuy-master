...
@interface TCWBAuthorizeViewController : CommonViewController<UIWebViewDelegate, UIAlertViewDelegate>{
    UIWebView                                   *webView;
    ...
    id<TCWBAuthorizeViewControllerDelegate>     __weak delegate;
}
