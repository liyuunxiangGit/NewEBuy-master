//
//  ProductParamInfoCell.m
//  SuningEBuy
//
//  Created by zhaojw on 12-4-20.
//  Copyright (c) 2012年 http://www.uuindex.com(javaliker@gmail.com). All rights reserved.
//
...
@implementation ProductParamInfoCell
...
- (UILabel *)markLbl{
    ...
    if (!_markLbl) {
        ...
        _markLbl.textColor = [UIColor colorWithRed:112.0/255 green:112.0/255 blue:112.0/255 alpha:1];
...
+ (CGFloat)height:(ProductParaDTO *)dto
{
    ...
    return ([ProductParamInfoCell getRowHeight:dto]+ cellHight);
}
