...
- (BOOL)isBindToHander:(NSString *)handlerName
{
    NSString *jsAction = [NSString stringWithFormat:@"SNNativeClient.isBindToHander('%@');", handlerName];
    NSString *result = [_webView stringByEvaluatingJavaScriptFromString:jsAction];
...
- (void)_flushMessageQueue {
    NSString *messageQueueString = [_webView stringByEvaluatingJavaScriptFromString:@"SNNativeClient._fetchQueue();"];
