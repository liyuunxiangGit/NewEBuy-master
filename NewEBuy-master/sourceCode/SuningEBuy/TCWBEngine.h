...
{
	id		__weak delegate;	// 用来保存委托接收体对象, 同时又不会增加delegate的引用计数
}
@property (nonatomic, weak) id		delegate;

@end

@interface TCWBEngine : NSObject <TCWBRequestDelegate,TCWBAuthorizeViewControllerDelegate>{
...
@property (nonatomic, strong) NSString          *ip_iphone;
