...
- (void)startAuthorize
{
    ...
    OWBAuthorizeWebViewController *wbController = [[OWBAuthorizeWebViewController alloc]init];
    
    AuthManagerNavViewController *nav = [[AuthManagerNavViewController alloc]initWithRootViewController:wbController];
    
    wbController.appKey = self.appKey;
    
    wbController.redirectURI = redirectURI;
    
    wbController.delegate = self;
        
    [self.navigationController presentModalViewController:nav animated:YES];
    
    TT_RELEASE_SAFELY(wbController);
...
#pragma mark - OWBAuthorizeWebViewDelegate Methods
