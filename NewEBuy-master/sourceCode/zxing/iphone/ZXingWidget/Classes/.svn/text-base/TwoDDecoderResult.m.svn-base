...
- (id)copyWithZone:(NSZone *)zone {
    ...
    TwoDDecoderResult *result = [[TwoDDecoderResult allocWithZone:zone] initWithText:newText points:newPoints];
    result.formatReader = self.formatReader;
    return result;
}
